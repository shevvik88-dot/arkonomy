...
### 16. Аудит экранов — Dashboard/Home ЗАКРЫТ 2026-07-18, Transactions ЗАКРЫТ 2026-07-19, Insights ЗАКРЫТ 2026-07-20, Recurring ЗАКРЫТ 2026-07-20, Savings ЗАКРЫТ 2026-07-20, дальше по очереди: Markets/StockDetail, Profile/Settings
...
Тот же шаблон (три категории, ничего не чинить без подтверждения, коммит после каждой группы перед следующей — см. CLAUDE.md Coding rules) — на следующий экран: **Markets/StockDetail**.
