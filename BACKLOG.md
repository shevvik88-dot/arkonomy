...
- [ ] **`#1A56DB` ("Plaid/bank-connect blue") захардкожен в 3 файлах** (`Profile.jsx` — 5 повторов, `OnboardingFlow.jsx`, `shared/PlaidLinkButton.jsx`), нигде не заведён именованной константой. Найдено при аудите Profile/Settings (2026-07-20) — тот же класс, что `#7C6BFF`/`#F5C842`/`#F5A623` выше. Все три цвета в этом пункте (плюс `#7C6BFF`) — кандидаты на один общий заход по кросс-файловой цветовой консолидации, а не 4 отдельных микро-задачи.
